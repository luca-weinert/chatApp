...
namespace ChatApp.Client.Wpf.Services.ListenerService
{
    public class TcpEndpoint
    {
        ...
        private void
            OnMessageReceivedConformationReceived(MessageReceivedConformationEventArgs messageReceivedConformation) =>
            MessageReceivedConformationReceived?.Invoke(this, messageReceivedConformation);
                    ...
                    if (dataPackage != null)
                        switch (dataPackage.PayloadType)
                        {
                            ...
                            case ChatProtocolPayloadTypes.MessageReceivedConfirmation:
                                Console.WriteLine(
                                    $"[Client]: Received data containing a message received confirmation");
                                ...
                                OnMessageReceivedConformationReceived(
